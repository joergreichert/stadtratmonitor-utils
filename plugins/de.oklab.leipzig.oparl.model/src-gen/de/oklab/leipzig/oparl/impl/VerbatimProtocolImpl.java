...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Verbatim Protocol</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class VerbatimProtocolImpl extends FileImpl implements VerbatimProtocol {
	 ...
	 * @generated
	 */
	protected VerbatimProtocolImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OparlPackage.Literals.VERBATIM_PROTOCOL;
	}
	...
	public Meeting getMeeting() {
		if (eContainerFeatureID() != OparlPackage.VERBATIM_PROTOCOL__MEETING) return null;
	...
	public NotificationChain basicSetMeeting(Meeting newMeeting, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newMeeting, OparlPackage.VERBATIM_PROTOCOL__MEETING, msgs);
		return msgs;
	}
	...
	public void setMeeting(Meeting newMeeting) {
		if (newMeeting != eInternalContainer() || (eContainerFeatureID() != OparlPackage.VERBATIM_PROTOCOL__MEETING && newMeeting != null)) {
			...
			if (newMeeting != null)
				msgs = ((InternalEObject)newMeeting).eInverseAdd(this, OparlPackage.MEETING__VERBATIM_PROTOCOL, Meeting.class, msgs);
			msgs = basicSetMeeting(newMeeting, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OparlPackage.VERBATIM_PROTOCOL__MEETING, newMeeting, newMeeting));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case OparlPackage.VERBATIM_PROTOCOL__MEETING:
				return eInternalContainer().eInverseRemove(this, OparlPackage.MEETING__VERBATIM_PROTOCOL, Meeting.class, msgs);
		}
